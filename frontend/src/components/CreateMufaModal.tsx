...
export const CreateMufaModal: React.FC<CreateMufaModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-3 sm:p-5 bg-slate-950/80 backdrop-blur-sm overflow-y-auto animate-fadeIn">
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden my-auto">
        {/* Cabecera */}
        <div className="bg-gradient-to-r from-slate-900 via-sky-950 to-slate-900 px-6 py-4 text-white flex items-center justify-between border-b border-sky-800/40">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-sky-500/20 border border-sky-400/30 rounded-xl text-sky-400">
              <GitCommit className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-base font-bold">Agregar Cierre de Empalme / Mufa</h3>
